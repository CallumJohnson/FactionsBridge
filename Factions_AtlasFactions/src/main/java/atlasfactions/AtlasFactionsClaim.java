...
/**
 * AtlasFactions implementation of {@link cc.javajobs.factionsbridge.bridge.infrastructure.struct.Claim}.
 * Object Target: {@link FLocation}.
 */
public class AtlasFactionsClaim extends AbstractClaim<FLocation> {
     ...
     */
    public AtlasFactionsClaim(@NotNull FLocation claim) {
        super(claim);
    }
    ...
    public Faction getFaction() {
        return new AtlasFactionsFaction(Board.getInstance().getFactionAt(claim));
    }
