...
/**
 * SaberFactions implementation of {@link cc.javajobs.factionsbridge.bridge.infrastructure.struct.FPlayer}.
 * Object Target: {@link FPlayer}.
 */
public class SaberFactionsFPlayer extends AbstractFPlayer<FPlayer> {
     ...
     */
    public SaberFactionsFPlayer(@NotNull FPlayer fPlayer) {
        super(fPlayer);
    }
    ...
    public Faction getFaction() {
        return new SaberFactionsFaction(fPlayer.getFaction());
    }
