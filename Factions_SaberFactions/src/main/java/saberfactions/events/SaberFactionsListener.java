...
/**
 * SaberFactions implementation of the Bridges needed to handle all Custom Events.
 *
 * @author Callum Johnson
 * @since 29/06/2021 - 10:52
 */
public class SaberFactionsListener implements Listener {
