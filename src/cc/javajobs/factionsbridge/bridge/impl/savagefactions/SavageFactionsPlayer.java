 ...
 */
public class SavageFactionsPlayer implements IFactionPlayer {
    ...
    public IFaction getFaction() {
        return new SavageFactionsFaction(fpl.getFaction());
    }
    ...
    public IRelationship getRelationTo(IFaction other) {
         Relation rel = fpl.getRelationTo(((Faction) other.asObject()));
         switch (rel) {
             case MEMBER:
