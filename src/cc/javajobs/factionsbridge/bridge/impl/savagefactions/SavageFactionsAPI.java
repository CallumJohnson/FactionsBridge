...
/**
 * SavageFactions implementation of IFactionAPI.
 *
 * @author Callum Johnson
 * @version 1.0
 * @since 26/02/2021 - 15:01
 */
public class SavageFactionsAPI implements IFactionsAPI {
    ...
    public IFaction getFactionByName(String name) {
        return new SavageFactionsFaction(Factions.getInstance().getByTag(name));
    }
    ...
    public IFaction getFaction(OfflinePlayer player) {
        return new SavageFactionsFaction(FPlayers.getInstance().getByOfflinePlayer(player).getFaction());
    }
    ...
    public IFactionPlayer getFactionPlayer(OfflinePlayer player) {
        return new SavageFactionsPlayer(FPlayers.getInstance().getByOfflinePlayer(player));
    }
