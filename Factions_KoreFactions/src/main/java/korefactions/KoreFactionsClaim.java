...
/**
 * KoreFactions implementation of {@link cc.javajobs.factionsbridge.bridge.infrastructure.struct.Claim}.
 * Object Target: {@link FLocation}.
 */
public class KoreFactionsClaim extends AbstractClaim<FLocation> {
     ...
     */
    public KoreFactionsClaim(@NotNull FLocation claim) {
        super(claim);
    }
    ...
    public Faction getFaction() {
        return new KoreFactionsFaction(Board.getInstance().getFactionAt(claim));
    }
